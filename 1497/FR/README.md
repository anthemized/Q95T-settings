## Reglages valides pour firmware 1497
...
| Teinte                  | +1R                              | +1R                    | +1R                  | +1R                   | +1R                  | +1R                    | +1R                             | +1R                    | **+3R**                      |
...
| Bleu                    | réglage/ajout -8/0               | réglage/ajout -8/0     | réglage/ajout -8/0   | réglage/ajout -8/0    | réglage/ajout -8/0   | réglage/ajout -10/0    | réglage/ajout -10/0             | réglage/ajout -10/0    | réglage/ajout -10/1          |
| Gamma                   | ST2084                           | ST2084                 | ST2084               | ST2084                | ST2084               | ST2084                 | ST2084                          | ST2084                 | ST2084                       |
| 1886 / ST2084           | **-1**                           | **-2**                 | **-2**               | **-3**                | **-3**               | **-2**                 | **-2**                          | **-1**                 | **-3**                       |
| Détail ombre            | **-1**                           | **0**                  | **0**                | **0**                 | **-1**               | **0**                  | **0**                           | **0**                  | **-1**                       |
